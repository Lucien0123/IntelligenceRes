    ...
    <div class="col-xs-10 RightContent" style="padding: 0;">
        ...
        <div class="RightContentForm">
            ...
            <div class="RightFormBody">
                <form id="publicNewsForm" action="${ctx }/sys/news/republishNewsAction">
                    ...
                    <div class="form-group has-success" hidden="hidden">
                        <input name="id" value="${editNews.id }" type="text" class="form-control input-lg" placeholder="请输入发布新闻咨询标题">
                    </div>
                    <div class="form-group has-success">
                        <label>新闻咨询标题</label>
                        <input name="newsTitle" value="${editNews.newsTitle }" type="text" class="form-control input-lg" placeholder="请输入发布新闻咨询标题">
                    </div>
                    <div class="form-group row has-warning">
                        <div class="col-xs-3">
                            <label>发布企业</label>
                            <input name="companyName" type="text" class="form-control input-lg" disabled="true" value="${editNews.companyName }">
                        </div>
                        <div class="col-xs-1"></div>
                        <div class="col-xs-3">
                            <label>发布人</label>
                            <input name="publisher" type="text" class="form-control input-lg" disabled="true" value="${editNews.publisher }">
                        </div>
                        <div class="col-xs-1"></div>
                        <div class="col-xs-3">
                            <label>发布时间</label>
                            <input type="text" class="form-control input-lg" disabled="true" value="${publishDateStr }">
                        </div>
                        <div class="col-xs-1"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <script type="text/plain" id="myEditor" style="width:100%;height:240px;">
                            ${editNews.newsContent}
                        </script>
                        <input type="text" id="newsContent" name="newsContent" hidden="hidden" />
                    </div>
                    <div class="form-group paddingleft30px margintop30px">
                        <button class="btn btn-lg btn-primary submitbutton150" type="submit" href="/sys/news/republishNewsAction">
                            提请审核发布
                        </button>
                    </div>
                </form>
